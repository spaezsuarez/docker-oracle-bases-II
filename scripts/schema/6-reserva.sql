...
Insert into RESERVA (K_RESERVA,F_RESERVA,F_INICIAL,F_FINAL,V_TOTAL,I_ESTADO,K_AGENCIA,K_CODCLIENTE) values ('20236',to_date('19/08/24','DD/MM/RR'),to_date('20/08/24','DD/MM/RR'),to_date('22/08/23','DD/MM/RR'),'690000','PAG','CENTRO','101');
